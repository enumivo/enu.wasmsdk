...
namespace enumivo {
   ...
   inline void check(bool pred, const char* msg) {
      if (!pred) {
         internal_use_do_not_use::enumivo_assert(false, msg);
      }
   }
   ...
   inline void check(bool pred, const std::string& msg) {
      if (!pred) {
         internal_use_do_not_use::enumivo_assert(false, msg.c_str());
      }
   }
   ...
   inline void check(bool pred, const char* msg, size_t n) {
      if (!pred) {
         internal_use_do_not_use::enumivo_assert_message(false, msg, n);
      }
   }
   ...
   inline void check(bool pred, const std::string& msg, size_t n) {
      if (!pred) {
         internal_use_do_not_use::enumivo_assert_message(false, msg.c_str(), n);
      }
   }
   ...
   inline void check(bool pred, uint64_t code) {
      if (!pred) {
         internal_use_do_not_use::enumivo_assert_code(false, code);
      }
   }
} // namespace enumivo
