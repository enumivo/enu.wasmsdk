...
namespace enumivo {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::enumivo::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::enumivo::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::enumivo::ignore<T>&) {
     return ds;
   }
}
