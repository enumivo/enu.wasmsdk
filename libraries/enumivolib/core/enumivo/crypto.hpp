...
namespace enumivo {
   ...
   inline DataStream& operator<<(DataStream& ds, const enumivo::public_key& pubkey) {
      ds << pubkey.type;
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, enumivo::public_key& pubkey) {
      ds >> pubkey.type;
    ...
    */
   template<typename DataStream>
   inline DataStream& operator<<(DataStream& ds, const enumivo::signature& sig) {
      ds << sig.type;
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, enumivo::signature& sig) {
      ds >> sig.type;
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return enumivo::checksum256 - Computed digest
    */
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return enumivo::checksum160 - Computed digest
    */
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return enumivo::checksum512 - Computed digest
    */
    ...
    *  @param sig - Signature
    *  @return enumivo::public_key - Recovered public key
    */
