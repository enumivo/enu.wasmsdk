...
#warning "<enumivolib/multi_index.hpp> is deprecated use <enumivo/multi_index.hpp>"
...
class multi_index
{
   ...
   public:
      ...
      const_iterator emplace( name payer, Lambda&& constructor ) {
         ...
         enumivo::check( _code.value == current_receiver(), "cannot create objects in table of another contract" ); // Quick fix for mutating db using multi_index that shouldn't allow mutation. Real fix can come in RC2.
      ...
      void modify( const T& obj, name payer, Lambda&& updater ) {
         ...
         enumivo::check( _code.value == current_receiver(), "cannot modify objects in table of another contract" ); // Quick fix for mutating db using multi_index that shouldn't allow mutation. Real fix can come in RC2.
      ...
      void erase( const T& obj ) {
         ...
         enumivo::check( _code.value == current_receiver(), "cannot erase objects in table of another contract" ); // Quick fix for mutating db using multi_index that shouldn't allow mutation. Real fix can come in RC2.
