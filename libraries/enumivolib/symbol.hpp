...
#warning "<enumivolib/symbol.hpp> is deprecated use <enumivo/symbol.hpp>"
namespace enumivo {
   ...
   */
   ...
   public:
      ...
      */
      ...
      friend inline DataStream& operator<<(DataStream& ds, const enumivo::symbol_code sym_code) {
      ...
      */
      template<typename DataStream>
      friend inline DataStream& operator>>(DataStream& ds, enumivo::symbol_code& sym_code) {
         uint64_t raw = 0;
