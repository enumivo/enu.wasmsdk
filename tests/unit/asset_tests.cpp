...
using enumivo::extended_symbol;
using enumivo::asset;
using enumivo::extended_asset;
...
// Definitions in `enumivo.cdt/libraries/enumivo/asset.hpp`
ENUMIVO_TEST_BEGIN(asset_type_test)
   silence_output(true);
...
// Definitions in `enumivo.cdt/libraries/enumivo/asset.hpp`
ENUMIVO_TEST_BEGIN(extended_asset_type_test)
   silence_output(true);

   static constexpr symbol sym_no_prec{"SYMBOLL",0};
   static constexpr symbol sym_prec{"SYMBOLL",63};

   static constexpr extended_symbol ext_sym_no_prec{sym_no_prec, name{"enumivoaccountj"}};
   static constexpr extended_symbol ext_sym_prec{sym_prec, name{"enumivoaccountj"}};
   ...
   CHECK_EQUAL( (extended_asset{{},ext_sym_no_prec}.contract), (name{"enumivoaccountj"}) )

   //// extended_asset(asset, name)
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"enumivoaccountj"}}.quantity), (asset{ 0LL, sym_no_prec}) )
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"enumivoaccountj"}}.contract), (name{"enumivoaccountj"}) )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         extended_asset{asset_no_prec, name{"enumivoaccountj"}} + extended_asset{asset_no_prec, name{"jtnuoccaoisoe"}};
      })
   )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         temp += extended_asset{asset_no_prec, name{"enumivoaccountj"}};
      })
   )
   ...
   // --------------------------------------------------------------------
   // friend bool operator!=(const extended_asset&, const extended_asset&)
   CHECK_EQUAL( (extended_asset{asset_no_prec, name{"enumivoaccountj"}} != extended_asset{asset_no_prec, name{"jtnuoccaoisoe"}}), true )
   CHECK_EQUAL( (extended_asset{asset{1LL, sym_no_prec}, {}} != extended_asset{asset{-1LL, sym_no_prec}, {}}), true )
   CHECK_EQUAL( (extended_asset{asset{1LL, sym_no_prec}, {}} != extended_asset{asset{ 0LL, sym_no_prec}, name{"enumivoaccountj"}}), true )
   ...
   CHECK_ASSERT( "type mismatch", (
      [&]() {
         bool b{extended_asset{{}, name{}} < extended_asset{{}, name{"enumivoaccountj"}}};
         return b;
      })
   )
...
int main(int argc, char* argv[]) {
   ENUMIVO_TEST(asset_type_test);
   ENUMIVO_TEST(extended_asset_type_test);
   return has_failed();
}
