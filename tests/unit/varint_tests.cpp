...
using enumivo::unsigned_int;
using enumivo::signed_int;
...
// Defined in `enumivo.cdt/libraries/enumivo/varint.hpp`
ENUMIVO_TEST_BEGIN(unsigned_int_type_test)
...
// Defined in `enumivo.cdt/libraries/enumivo/varint.hpp`
ENUMIVO_TEST_BEGIN(signed_int_type_test)
   silence_output(false);
...
int main(int argc, char* argv[]) {
   ENUMIVO_TEST(unsigned_int_type_test)
   ENUMIVO_TEST(signed_int_type_test);
   return has_failed();
}
