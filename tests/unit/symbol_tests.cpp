...
// Definitions in `enumivo.cdt/libraries/enumivo/symbol.hpp`
ENUMIVO_TEST_BEGIN(symbol_code_type_test)
   silence_output(true);
...
// Definitions in `enumivo.cdt/libraries/enumivo/symbol.hpp`
ENUMIVO_TEST_BEGIN(symbol_type_test)
   silence_output(true);
...
// Definitions in `enumivo.cdt/libraries/enumivo/symbol.hpp`
ENUMIVO_TEST_BEGIN(extended_symbol_type_test)
   silence_output(true);
...
int main(int argc, char* argv[]) {
   ENUMIVO_TEST(symbol_code_type_test);
   ENUMIVO_TEST(symbol_type_test);
   ENUMIVO_TEST(extended_symbol_type_test);
   return has_failed();
}
