...
struct be_test {
   ...
   be_test(int i) : val{i} {}
   int val;
   ENULIB_SERIALIZE( be_test, (val) )
};

// Definitions in `enumivo.cdt/libraries/enumivo/datastream.hpp`
ENUMIVO_TEST_BEGIN(datastream_test)
   silence_output(true);
...
// Definitions in `enumivo.cdt/libraries/enumivo/datastream.hpp`
ENUMIVO_TEST_BEGIN(datastream_specialization_test)
   silence_output(true);
...
// Definitions in `enumivo.cdt/libraries/enumivo/datastream.hpp`
ENUMIVO_TEST_BEGIN(datastream_stream_test)
   silence_output(true);
...
// Definitions in `enumivo.cdt/libraries/enumivo/datastream.hpp`
ENUMIVO_TEST_BEGIN(misc_datastream_test)
   silence_output(true);
...
int main(int argc, char* argv[]) {
   ENUMIVO_TEST(datastream_test);
   ENUMIVO_TEST(datastream_specialization_test);
   ENUMIVO_TEST(datastream_stream_test);
   ENUMIVO_TEST(misc_datastream_test);
   return has_failed();
}
