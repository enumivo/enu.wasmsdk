...
using enumivo::milliseconds;
using enumivo::minutes;
using enumivo::seconds;
...
// Definitions in `enumivo.cdt/libraries/enumivo/time.hpp`
ENUMIVO_TEST_BEGIN(microseconds_type_test)
silence_output(true);
...
// Definitions in `enumivo.cdt/libraries/enumivo/time.hpp`
ENUMIVO_TEST_BEGIN(time_point_type_test)
   silence_output(true);
...
// Definitions in `enumivo.cdt/libraries/enumivo/time.hpp`
ENUMIVO_TEST_BEGIN(time_point_sec_type_test)
   silence_output(true);
...
// Definitions in `enumivo.cdt/libraries/enumivo/time.hpp`
ENUMIVO_TEST_BEGIN(block_timestamp_type_test)
   silence_output(true);
...
int main(int argc, char* argv[]) {
   ENUMIVO_TEST(microseconds_type_test);
   ENUMIVO_TEST(time_point_type_test);
   ENUMIVO_TEST(time_point_sec_type_test);
   ENUMIVO_TEST(block_timestamp_type_test);
   return has_failed();
}
