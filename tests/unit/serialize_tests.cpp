...
struct D1 : public B {
   const int i{};
   ENULIB_SERIALIZE_DERIVED( D1, B, (i) )
...
struct D2 : public D1 {
   ...
   ENULIB_SERIALIZE_DERIVED( D2, D1, (v) )
...
// Definitions in `enumivo.cdt/libraries/enumivo/serialize.hpp`
ENUMIVO_TEST_BEGIN(serialize_test)
   silence_output(true);
