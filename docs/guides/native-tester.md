...
- ENUMIVO_TEST_BEGIN(X) : This macro defines the beginning of a unit test and assigns `X` as the symbolic name of that test.
- ENUMIVO_TEST_END : This macro defines the end of a unit test.
- ENUMIVO_TEST(X) : This is used to run a particular named unit test `X` in the main function.
