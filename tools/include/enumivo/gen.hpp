...
struct generation_utils {
   ...
   static inline bool has_enumivo_ricardian( const clang::CXXMethodDecl* decl ) {
      return decl->hasEnumivoRicardian();
   }
   static inline bool has_enumivo_ricardian( const clang::CXXRecordDecl* decl ) {
      return decl->hasEnumivoRicardian();
   }

   static inline std::string get_enumivo_ricardian( const clang::CXXMethodDecl* decl ) {
      return decl->getEnumivoRicardianAttr()->getName();
   }
   static inline std::string get_enumivo_ricardian( const clang::CXXRecordDecl* decl ) {
      return decl->getEnumivoRicardianAttr()->getName();
   }

   static inline std::string get_action_name( const clang::CXXMethodDecl* decl ) {
      std::string action_name = "";
      auto tmp = decl->getEnumivoActionAttr()->getName();
      if (!tmp.empty())
         return tmp;
   ...
   static inline std::string get_notify_pair( const clang::CXXMethodDecl* decl ) {
      ...
      auto tmp = decl->getEnumivoNotifyAttr()->getName();
      return tmp;
   }
